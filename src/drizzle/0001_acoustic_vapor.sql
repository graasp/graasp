...
ALTER TABLE "action" ADD COLUMN "extra_new" jsonb;--> statement-breakpoint
...
ALTER TABLE "action" ADD COLUMN "geolocation_new" jsonb DEFAULT '{}'::jsonb;--> statement-breakpoint
UPDATE "action" SET "geolocation_new" = "geolocation"::jsonb; --> statement-breakpoint
...
-- CONTINUE HERE !!!!!!
----
ALTER TABLE "item" ALTER COLUMN "extra" SET DATA TYPE jsonb;--> statement-breakpoint


ALTER TABLE "item" ALTER COLUMN "settings" SET DATA TYPE jsonb;--> statement-breakpoint
ALTER TABLE "app_setting" ALTER COLUMN "id" SET DEFAULT gen_random_uuid();--> statement-breakpoint
ALTER TABLE "app_setting" ALTER COLUMN "data" SET DATA TYPE jsonb USING data::jsonb;--> statement-breakpoint
ALTER TABLE "app_setting" ALTER COLUMN "data" SET DEFAULT '{}'::jsonb;--> statement-breakpoint
ALTER TABLE "item_login_schema" ALTER COLUMN "id" SET DEFAULT gen_random_uuid();--> statement-breakpoint
ALTER TABLE "item_login_schema" ALTER COLUMN "type" SET DATA TYPE item_login_schema_status;--> statement-breakpoint
ALTER TABLE "item_login_schema" ALTER COLUMN "status" SET DATA TYPE item_login_schema_status;--> statement-breakpoint
...
ALTER TABLE "item_membership" ALTER COLUMN "permission" SET DATA TYPE permission_enum;--> statement-breakpoint
ALTER TABLE "item_validation" ALTER COLUMN "id" SET DEFAULT gen_random_uuid();--> statement-breakpoint
ALTER TABLE "item_validation" ALTER COLUMN "process" SET DATA TYPE item_validation_process;--> statement-breakpoint
ALTER TABLE "item_validation" ALTER COLUMN "status" SET DATA TYPE item_validation_status;--> statement-breakpoint
...
ALTER TABLE "item_visibility" ALTER COLUMN "type" SET DATA TYPE item_visibility_type;--> statement-breakpoint
...
-- DROP TYPE "public"."action_request_export_format_enum";--> statement-breakpoint
-- DROP TYPE "public"."chat_mention_status_enum";--> statement-breakpoint
-- DROP TYPE "public"."short_link_platform_enum";--> statement-breakpoint
-- DROP TYPE "public"."tag_category_enum";
