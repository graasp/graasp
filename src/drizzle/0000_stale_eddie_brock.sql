...
CREATE INDEX "IDX_item_membership_account_id_permission" ON "item_membership" USING btree ("account_id" uuid_ops,"permission" uuid_ops);--> statement-breakpoint
...
CREATE INDEX "IDX_61546c650608c1e68789c64915" ON "app_setting" USING btree ("item_id" text_ops,"name" text_ops);--> statement-breakpoint
