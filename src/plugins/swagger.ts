  ...
  await instance.register(swaggerPlugin, {
    openapi: {
      ...
      tags: [
        ...
        { name: 'chatbot', description: 'Endpoints related to chatbots' },
        { name: 'current', description: 'Endpoints related to current user' },
        { name: 'etherpad', description: 'Endpoints related to etherpad' },
        { name: 'export', description: 'Endpoints related to exporting, download items' },
        { name: 'favorite', description: 'Endpoints related to bookmarked items' },
        { name: 'file', description: 'Endpoints related to files' },
        { name: 'flag', description: 'Endpoints related to flagged items' },
        ...
        { name: 'import', description: 'Endpoints related to importing files' },
        { name: 'item-login', description: 'Endpoints related to pseudonymized login in item' },
        {
          name: 'item-membership',
          description: 'Endpoints related to memberships of users to item',
        },
        ...
        { name: 'meta', description: 'Endpoints related to system' },
