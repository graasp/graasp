...
export class migrations1679669193721 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query('ALTER TABLE action_request_export RENAME TO action_request_export_old');
        ...
        await queryRunner.query('ALTER TABLE item_validation_group RENAME TO item_validation_group_old');
        await queryRunner.query('ALTER TABLE item_validation_review RENAME TO item_validation_review_old');
        await queryRunner.query('ALTER TABLE item_validation_process RENAME TO item_validation_process_old');
        await queryRunner.query('ALTER TABLE item_validation_status RENAME TO item_validation_status_old');
        await queryRunner.query('ALTER TABLE item_validation_review_status RENAME TO item_validation_review_status_old');
        ...
        await queryRunner.query(`CREATE TABLE "member" (
            ...
            `);
        await queryRunner.query('INSERT INTO "member" (id, type, email, name, extra, created_at, updated_at) SELECT id, type, email, name, extra, created_at, updated_at from member_old');
        ...
        await queryRunner.query(`CREATE TABLE "item" (
                ...
                `);
        await queryRunner.query('INSERT INTO "item" (id, name, type, description, path, creator_id, extra, settings, created_at, updated_at) SELECT id, name, type, description, path, creator, extra, settings, created_at, updated_at from item_old');
        ...
        await queryRunner.query('INSERT INTO "item_membership" (item_path, member_id, creator_id, permission, created_at, updated_at) SELECT item_path, member_id, creator, permission, created_at, updated_at from item_membership_old');
        ...
        // item like
        await queryRunner.query('CREATE TABLE "item_like" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "creator_id" uuid NOT NULL, "item_id" uuid NOT NULL REFERENCES item("id") ON DELETE CASCADE, CONSTRAINT "id" UNIQUE ("creator_id", "item_id"), CONSTRAINT "PK_3cca97fd246db52b4a34049b6a1" PRIMARY KEY ("id"))');
        await queryRunner.query('INSERT INTO "item_like" (creator_id, item_id, created_at) SELECT member_id, item_id, created_at FROM item_like_old');
        ...
        // TODO: production tag
        await queryRunner.query('INSERT INTO "item_published" (creator_id, item_path, created_at) SELECT creator, item_path, created_at FROM item_tag_old WHERE id=\'ea9a3b4e-7b67-44c2-a9df-528b6ae5424f\'');
        ...
        await queryRunner.query('ALTER TABLE "item_flag" ADD CONSTRAINT "item-flag-creator" UNIQUE ("item_id", "type", "creator_id")');
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query('INSERT INTO "member_old" (id, type, email, name, extra, created_at, updated_at) SELECT id, type::member_type_enum, email, name, extra::jsonb, created_at, updated_at from member');
        await queryRunner.query('UPDATE "member_old" set password = (SELECT password FROM member_password where member_id = member_old.id)');
...
// drop new table
        ...
        await queryRunner.query('ALTER TABLE item_validation_group_old RENAME TO item_validation_group');
        await queryRunner.query('ALTER TABLE item_validation_review_old RENAME TO item_validation_review');
        await queryRunner.query('ALTER TABLE item_validation_process_old RENAME TO item_validation_process');
