...
export class ActionRepository {
   ...
   */
  async deleteAllForAccount(dbConnection: DBConnection, accountId: string): Promise<void> {
    await dbConnection.delete(actionsTable).where(eq(actionsTable.accountId, accountId));
  }
