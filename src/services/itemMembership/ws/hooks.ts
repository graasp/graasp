...
export function registerItemMembershipWsHooks(
  ...
  itemMembershipService.hooks.setPostHook('create', async (member, db, membership) => {
  ...
  itemMembershipService.hooks.setPostHook('update', async (member, db, membership) => {
  ...
  itemMembershipService.hooks.setPostHook('delete', async (member, db, membership) => {
...
export const membershipWsHooks: FastifyPluginAsync = async (fastify) => {
  ...
  registerItemMembershipWsHooks(db, websockets, itemService, itemMembershipService);
};
