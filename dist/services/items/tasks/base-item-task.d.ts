...
export declare abstract class BaseItemTask implements ItemTask {
    ...
    parentItemId?: string;
    constructor(member: Member, itemService: ItemService, itemMembershipService: ItemMembershipService, partialSubtasks?: boolean);
